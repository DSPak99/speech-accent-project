...
print("1. Загрузка моделей и процессора...")
...
print("2. Расчет WER по каждой языковой группе...")

for lang in LANGUAGES:
    print(f"Оценка на выборке: {lang}...")
...
print("\n3. Генерация графика результатов...")
...
print("График успешно сохранен как 'wer_comparison_chart.png'!")